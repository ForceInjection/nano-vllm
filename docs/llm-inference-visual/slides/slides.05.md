...
```mermaid {scale: 0.7}
flowchart LR
    L01["L01"] --> L02["L02"] --> L03["L03"] --> L04["L04"]
    L04 --> L05["<strong>L05</strong><br/>Prefill Batching"]
    L05 --> L06["L06<br/>Decode"]
    L06 --> L07["L07<br/>Attention"] --> L08["L08"]
    style L05 fill:#3b82f6,color:#fff,stroke:#2563eb,stroke-width:3px
```
